...
class YoutubeMp3Downloader extends EventEmitter {
    ...
    async performDownload(task, callback) {
        ...
        var videoTitle = typeof(info.videoDetails.title) != 'undefined' ? this.cleanFileName(info.videoDetails.title) : 'Unknown';
        var artist = 'Unknown';
        var title = 'Unknown';
        var thumbnail = info.videoDetailsv.thumbnails ? info.videoDetails.thumbnails[0].url : info.videoDetails.thumbnail || null;
